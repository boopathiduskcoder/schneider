                                ...
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                             <div class="form-group row">
                                                <label class="control-label col-md-4">Equipment List</label>
                                                <select class="form-control custom-select col-md-6 proid" data-placeholder="Select Equipment" tabindex="1" name="equipmentid">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <select class="form-control custom-select col-md-6 proid" data-placeholder="Select Department" style="width:25%" tabindex="1" name="departmentid">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-4">Type of Breakdown</label>
                                                <select class="form-control custom-select col-md-6 proid" data-placeholder="Select Breakdown" style="width:25%" tabindex="1" name="breakdownid">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-4">Reported Date & Time</label>
                                                <input type="text" name="dateandtime" class="form-control col-md-6 proid" id="datetimepicker1" id="recipient-name1">
                                            </div>
                                            <div class="form-group row">
                                                <label for="message-text" class="control-label col-md-4">Details</label>
                                                <textarea class="form-control col-md-6 proid" name="details" id="message-text1" minlength="10" maxlength="1400"></textarea>
                                            </div>                                            
                                    </div>
...
$('#btnSubmit').find('[name="dateandtime"]').val(response.breakbyid.dateandtime).end();  
