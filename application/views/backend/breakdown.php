                                           ...
                                           ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>maintenance/View_complaint?id=<?php echo base64_encode($value->id); ?>" title="Edit" class="btn btn-sm btn-success waves-effect waves-light"><i class="fa fa-eye"></i></a>
                                                </td>
                                            </tr>
                                            <?php }?>
                                        </tbody>
