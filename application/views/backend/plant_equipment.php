					...
					<div class="row">
						<div class="col-md-6">      
							...
							<div class="form-group">
								...
								<select name="type" class="select2 form-control custom-select" style="width: 100%" required value="">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" name="warrenty" value="" class="form-control" id="recipient-name1" autocomplete="off">
							</div>
							<div class="form-group">
								<label class="control-label">Power suply</label>
								<input type="text" name="power" value="" class="form-control" id="recipient-name1" autocomplete="off">
							</div>
							<div class="form-group">
