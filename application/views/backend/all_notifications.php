            ...
            <div class="col-md-4">
                <div class="card p-3">
                    ...
                    <?php if(!empty( $value->image)){ ?>
                        <img src="<?php echo base_url(); ?>assets/images/equipments/<?php echo $value->image; ?>" width="70" height="70">
                        <?php } else{?>
                            <img src="<?php echo base_url(); ?>assets/images/no_image.png " width="70"  height="70">
                         <?php } ?>
