...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-cart-plus"></i> Tools/Others</h3>
		</div>
	...
	<div class="container-fluid">
		<div class="row m-b-10"> 
			...
			<?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                        ...
                        <?php } else { ?>  
				<button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#assetsmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Add Tools </a></button>
				<?php } ?>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
				<div class="card card-outline-info">
					<div class="card-header">
						<h4 class="m-b-0 text-white"> Tools List</h4>
					</div>
	...
	<a href="<?php echo base_url(); ?>equipment/download_tools" title="Edit" class="btn btn-info waves-effect waves-light">Export</a>
