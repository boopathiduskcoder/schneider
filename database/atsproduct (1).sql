...
(19, '1', 'Ass name1', 'Ass brand1', 'Ass model1', 'sr456', 'Configuration', '2022-10-01', '12000', '2', '10'),
(20, '2', 'Ass name2', 'Ass brand2', 'Ass model2', 'df355', 'Configuration', '2022-10-01', '24000', '2', '10'),
(21, '3', 'Ass name3', 'Ass brand3', 'Ass model3', 'edf3455', 'Configuration', '2022-10-02', '10000', '1', '4'),
(22, '4', 'Ass name4', 'Ass brand4', 'Ass model4', 'dd2345', 'Configuration', '2022-10-02', '25000', '3', '20');
...
--
-- Table structure for table `breakdowntypes`
--

CREATE TABLE `breakdowntypes` (
  `id` int(10) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `breakdowntypes`
--

INSERT INTO `breakdowntypes` (`id`, `name`) VALUES
(1, 'Mechanical'),
(2, 'Electrical'),
(3, 'Civil'),
(4, 'Other');
...
(11, 'zsassdsf', 3, 'ABC/EQP/2022/0010', 'sdfghj', '12', '2022-10-03', 'xcvb', 22, 'sadfghj', 1, '3', '34567', 'active', 'saasddfghjklsdfghjkldf', '62c32009d08b1250546bf9ec18616d95.jpg', 'Schneider_MMS_Project_development.docx', '2022-10-03 06:22:03', 0),
(12, 'asdfghj', 1, 'ABC/EQP/2022/0009', 'sadfghj', '1234', '2022-10-03', 'zxcvbnm,', 3245, 'sxxdfghjkl', 1, '23', '23456', 'in-active', 'sazxcdvfdfghjklsdfghjk', 'e069e9a6ca188b451d857aa97e2958e2.jpg', 'Santhosh1.docx', '2022-10-03 06:30:50', 0),
(18, 'asdfrgthj', 1, 'ABC/EQP/2022/0010', 'sdfgh', '23', '2022-10-04', 'sdfghj', 23456, 'xcvbghjk', 1, '2', '12341', 'active', 'sadfghjklsdfghj', '4d3ca56ecd571fdd9b22f9daa0eb42e4.jpg', '', '2022-10-03 08:01:46', 0),
(19, 'test', 1, 'ABC/EQP/2022/0011', 'sdfghj', '23', '2022-10-04', 'xzcvbgnm', 122, 'dfghj', 1, '3', '3253', 'active', 'edfbgvhnjmklxzcvbghn', '', '', '2022-10-03 08:08:35', 0),
(20, 'tests', 1, 'ABC/EQP/2022/0012', 'sdfgh', '12', '2022-10-04', 'dfghj', 23456, 'sdfghjk', 1, '2', '2342', 'active', 'xcvbghjklfdghjk', '26d799a52f935bbd3c707376be1271db.jpg', '73823889_16646131794451.pdf', '2022-10-03 08:10:31', 0),
...
INSERT INTO `stock` (`id`, `productname`, `vendor`, `stock_in_hand`, `unit`, `created_at`) VALUES
(1, 'Product A', 'anusha', 10, 'ml', '2022-09-30 13:00:38'),
(2, 'Product B', 'test', 0, 'pack', '2022-09-30 13:00:38');
...
INSERT INTO `technicians` (`id`, `firstname`, `lastname`, `email`, `password`, `contact`, `status`, `created_at`) VALUES
(2, 'ezhil', 'e', 'ezhil@gmail.com', '5d9e1f3398b12ded730b742cbab8e7f0', 324567, 'active', '2022-10-05 08:57:35'),
(6, 'sdfg', 'sdfgh', 'test@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 23456345, 'active', '2022-10-05 11:02:24');
...
--
-- Indexes for table `breakdowntypes`
--
ALTER TABLE `breakdowntypes`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `assets`
  MODIFY `ass_id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
